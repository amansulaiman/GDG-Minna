...
public class GDGBenin extends ActionBarActivity {
    private WebView webView;
    private ProgressBar progressBarT4 = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gdgbenin);
        webView = (WebView) findViewById(R.id.webView8);
        progressBarT4 = (ProgressBar) findViewById(R.id.progressBar8);
        ...
        progressBarT4.setVisibility(View.VISIBLE);
        webView.loadUrl("https://developers.google.com/groups/chapter/102541424647802000372/");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_gdgbenin, menu);
        return true;
    }
