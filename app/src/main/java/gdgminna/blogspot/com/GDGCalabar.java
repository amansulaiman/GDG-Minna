...
public class GDGCalabar extends ActionBarActivity {
    private WebView webView;
    private ProgressBar progressBarT4 = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gdgcalabar);
        webView = (WebView) findViewById(R.id.webView11);
        progressBarT4 = (ProgressBar) findViewById(R.id.progressBar11);
        ...
        progressBarT4.setVisibility(View.VISIBLE);
        webView.loadUrl("https://developers.google.com/groups/chapter/104102236676361936871/");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_gdgcalabar, menu);
        return true;
    }
