...
public class GDGAdo_Ekiti extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gdgado__ekiti);
        webView = (WebView) findViewById(R.id.webView5);
        progressBarT4 = (ProgressBar) findViewById(R.id.progressBar5);
        ...
        progressBarT4.setVisibility(View.VISIBLE);
        webView.loadUrl("https://developers.google.com/groups/chapter/110463793540880663642/");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_gdgado__ekiti, menu);
        return true;
    }
