...
public class GDGAbuja extends ActionBarActivity {
    private WebView webView;
    private ProgressBar progressBarT4 = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gdgabuja);
        webView = (WebView) findViewById(R.id.webView4);
        progressBarT4 = (ProgressBar) findViewById(R.id.progressBar4);
        ...
        progressBarT4.setVisibility(View.VISIBLE);
        webView.loadUrl("https://developers.google.com/groups/chapter/114932120587711040822/");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_gdgabuja, menu);
        return true;
    }
