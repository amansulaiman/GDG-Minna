...
public class GDGFUNAAB extends ActionBarActivity {
    private WebView webView;
    private ProgressBar progressBarT4 = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gdgfunaab);
        webView = (WebView) findViewById(R.id.webView15);
        progressBarT4 = (ProgressBar) findViewById(R.id.progressBar15);
        ...
        progressBarT4.setVisibility(View.VISIBLE);
        webView.loadUrl("https://developers.google.com/groups/chapter/103664297074109377242/");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_gdgfunaab, menu);
        return true;
    }
