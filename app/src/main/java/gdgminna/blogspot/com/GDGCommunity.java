...
public class GDGCommunity extends Fragment {
    private WebView mwebView;
    private View rootView = null;
    private ProgressBar progressBarT4 = null;

    public static GDGCommunity newInstance() {
        GDGCommunity fragment = new GDGCommunity();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_gdgcommunity, container, false);
        mwebView = (WebView) rootView.findViewById(R.id.webView);
        progressBarT4 = (ProgressBar) rootView.findViewById(R.id.progressBar);
